...
class Temperature:
    """
    represent a temperature values extracted from the timeandata.com/weather webpage
    """
    headers = {
        'pragma': 'no-cache',
    ...
    def _scrape(self):
        "Extracts a values as instructed by the yml file and returns a dictionary"
        url = self._build_url()
